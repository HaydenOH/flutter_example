...
class LineChartSample5 extends StatelessWidget {
  final List<int> showIndexes = const [1, 2, 3, 4, 5, 6];
      ...
      LineChartBarData(
        ...
        gradient: const LinearGradient(
          colors: [
            ...
            Color.fromARGB(255, 0, 253, 17),
            Color.fromARGB(255, 246, 0, 16),
          ],
          stops: [0.5, 0.5],
              ...
              lineTouchData: LineTouchData(
                    ...
                    return TouchedSpotIndicatorData(
                      ...
                      FlDotData(
                        ...
                        getDotPainter: (spot, percent, barData, index) {
                          // print(
                          //     "12333333333333::::::::::::::::::::::::::${spot}${percent}${barData}${index}");
                ...
                touchTooltipData: LineTouchTooltipData(
                  ...
                  getTooltipItems: (List<LineBarSpot> lineBarsSpot) {
                    print("lineBarsSpot:::: ${lineBarsSpot}");
                    return lineBarsSpot.map((lineBarSpot) {
                      print("item:::: ${lineBarSpot}");
